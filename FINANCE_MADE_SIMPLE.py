...
.hero-container::before {
    ...
    width: 200%;
    height: 200%;
    background: radial-gradient(circle, rgba(255,68,68,0.08) 0%, transparent 50%);
...
.hero-title {
    font-size: 3rem;
    font-weight: 800;
    background: linear-gradient(135deg, #FFFFFF 0%, #FF6B6B 50%, #FF4444 100%);
...
.stat-number { font-size: 1.8rem; font-weight: 700; color: #FF4444; }
...
with hero_col2:
    ...
    try:
        ...
        st.markdown("""
        <div style="background: linear-gradient(135deg, #1a1a2e 0%, #0a0a0a 100%); 
                    padding: 40px; border-radius: 15px; text-align: center;
                    border: 2px solid rgba(255,68,68,0.3);">
            <div style="font-size: 3rem;">📈</div>
            <div style="color: #FF4444; font-weight: bold; font-size: 1.2rem;">STOCKINVESTING.AI</div>
        </div>
        """, unsafe_allow_html=True)
    st.markdown('</div>', unsafe_allow_html=True)
