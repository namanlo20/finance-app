...
# This replaces lines 7343-8025 in the main file
    ...
    # ============= LESSON LIBRARY =============
    # Complete lesson data with quizzes
    LEARN_HUB_LESSONS = {'B1': {'id': 'B1',
        'level': 'Beginner',
        'topics': ['Foundations'],
        'title': 'Market Mechanics',
        'time_min': 5,
        'why_it_matters': 'Foundation of how markets work and why prices move',
        'summary': ['Buying stock represents ownership in a company',
                    'Prices reflect future expectations, not just today',
                    'Market cap = price × shares outstanding',
                    'Volatility is normal - expectations constantly update'],
        'key_ideas': ['Stock represents fractional ownership',
                      'Price = collective guess about future value',
                      'News moves stocks by changing expectations',
                      'Higher uncertainty = wider price swings',
                      'Long-term: cash flows matter most'],
        'common_mistakes': ['Thinking stock price = company quality',
                            'Expecting price to match analysis instantly',
                            'Ignoring that markets are forward-looking',
                            'Panic when volatility happens',
                            'Confusing noise with signal'],
        'checklist': ['Understand stock = ownership',
                      'Recognize prices reflect expectations',
                      'Accept volatility as normal',
                      'Focus on fundamentals over time'],
        'quiz': [{'question': 'Buying stock represents:',
                  'options': ['A) Ownership',
                              'B) Loan to company',
                              'C) Coupon for products',
                              'D) Guarantee of profits'],
                  'correct': 0,
                  'explanation': 'Stocks give you fractional ownership in a company, including claims on future '
                                 'profits.'},
                 {'question': 'Prices move mainly due to:',
                  'options': ['A) Dividends daily', 'B) Expectations', 'C) CEOs set them', 'D) Illegal activity'],
                  'correct': 1,
                  'explanation': 'Stock prices primarily move based on changing expectations about future '
                                 'performance.'},
                 {'question': 'Market cap is:',
                  'options': ['A) Price × Revenue', 'B) Price × Shares', 'C) Profit / Price', 'D) Debt / Equity'],
                  'correct': 1,
                  'explanation': 'Market capitalization = stock price × total shares outstanding.'}],
        'apply_action': {'type': 'company_analysis', 'ticker': 'AAPL'},
        'xp': 10},
 'B2': {'id': 'B2',
        'level': 'Beginner',
        ...
        'time_min': 7,
        'why_it_matters': 'Time is your biggest advantage in investing',
        'summary': ['Compounding means returns on returns',
                    'Long horizons let you ride through volatility cycles',
                    'Patience beats constant trading for most investors',
                    'Years matter more than timing'],
        'key_ideas': ['Compounding requires time to work',
                      "Short-term noise doesn't matter over decades",
                      'Switching constantly destroys compounding',
                      'Emergency cash prevents forced selling',
                      'Long-term reduces timing risk'],
        'common_mistakes': ['Expecting instant results',
                            'Trading too frequently',
                            'Not having emergency reserves',
                            'Giving up after one bad year',
                            'Comparing to short-term winners'],
        'checklist': ['Set realistic time horizon (5+ years)',
                      'Keep emergency cash separate',
                      'Resist urge to constantly trade',
                      'Focus on years, not days'],
        'quiz': [{'question': 'Compounding needs:',
                  'options': ['A) Daily trades', 'B) Time', 'C) No dividends', 'D) Penny stocks'],
                  'correct': 1,
                  'explanation': 'Compounding requires time to let returns build on previous returns.'},
                 {'question': 'Long time horizon helps by:',
                  'options': ['A) Eliminating risk',
                              'B) Letting you ride cycles',
                              "C) Can't drop",
                              'D) Guaranteed wins'],
                  'correct': 1,
                  'explanation': 'Long horizons allow you to ride through market cycles and volatility.'},
                 {'question': 'Common mistake:',
                  'options': ['A) Diversifying', 'B) Switching constantly', 'C) Emergency cash', 'D) Learning'],
                  'correct': 1,
                  'explanation': 'Constant switching destroys compounding and increases costs.'}],
        'apply_action': {'type': 'market_overview'},
        'xp': 10},
 'B3': {'id': 'B3',
        'level': 'Beginner',
        'topics': ['ETFs', 'Risk'],
        ...
        'time_min': 6,
        'why_it_matters': 'Understanding diversification and risk management basics',
        'summary': ['Index funds spread risk across many companies',
                    'Single stocks are more volatile but can outperform',
                    'Core-satellite approach: index core + selective stocks',
                    'Loss aversion makes volatility feel worse than it is'],
        'key_ideas': ['Index reduces single-company risk',
                      "Volatility doesn't equal bad investment",
                      'Most active investors underperform index',
                      'Core-satellite balances safety and opportunity',
                      'Know your loss tolerance before investing'],
        'common_mistakes': ['All-or-nothing thinking',
                            'Comparing to best performer only',
                            'Underestimating emotional impact',
                            'No plan for downturns',
                            'Thinking index = boring/safe'],
        'checklist': ['Decide index % vs stock picking %',
                      'Accept index means average returns',
                      'Build core before satellites',
                      'Test loss tolerance with small amounts'],
        'quiz': [{'question': 'Index fund reduces:',
                  'options': ['A) Interest rates',
                              'B) Single-company risk',
                              'C) Inflation',
                              'D) Foreign exchange risk'],
                  'correct': 1,
                  'explanation': 'Index funds spread risk across many companies, reducing single-company risk.'},
                 {'question': 'Core-satellite means:',
                  'options': ['A) Cash + bonds',
                              'B) Index core + small stock bets',
                              'C) Options only',
                              'D) One sector only'],
                  'correct': 1,
                  'explanation': 'Core-satellite = stable index foundation + smaller individual stock positions.'},
                 {'question': 'Loss aversion means:',
                  'options': ['A) Love taking risks',
                              'B) Losses hurt more than gains feel good',
                              'C) Always buy dips',
                              'D) Dividends only'],
                  'correct': 1,
                  'explanation': 'Loss aversion = psychological tendency where losses feel twice as bad as equal gains '
                                 'feel good.'}],
        'apply_action': {'type': 'risk_quiz'},
        'xp': 10},
 'B4': {'id': 'B4',
        'level': 'Beginner',
        'topics': ['ETFs'],
        'title': 'ETFs 101',
        'time_min': 5,
        'why_it_matters': 'Understanding how ETFs work and their costs',
        'summary': ['ETF holds a basket of stocks in one ticker',
                    'Expense ratio is annual fee (keep it low)',
                    'Tracking means matching a benchmark',
                    'More liquid than mutual funds'],
        'key_ideas': ['Buy/sell like stocks during market hours',
                      'Diversification in one purchase',
                      'Low-cost ETFs often beat active funds',
                      'Check holdings and expense ratio',
                      'Some ETFs are leveraged or inverse (risky)'],
        'common_mistakes': ['Ignoring expense ratios',
                            'Trading ETFs too frequently',
                            "Not understanding what's inside",
                            'Buying thematic ETFs without research',
                            'Confusing ETFs with individual stocks'],
        'checklist': ['Check expense ratio (aim <0.20%)',
                      'Review top 10 holdings',
                      'Understand the index it tracks',
                      'Consider trading volume for liquidity'],
        'quiz': [{'question': 'ETF holds:',
                  'options': ['A) Cash only', 'B) Basket of securities', 'C) One stock', 'D) Only bonds'],
                  'correct': 1,
                  'explanation': 'ETFs hold a basket of securities (stocks, bonds, etc.) in one tradeable package.'},
                 {'question': 'Expense ratio is:',
                  'options': ['A) One-time tax', 'B) Annual fee', 'C) Commission', 'D) Dividend'],
                  'correct': 1,
                  'explanation': 'Expense ratio is the annual fee charged as a percentage of assets.'},
                 {'question': 'Tracking means:',
                  'options': ['A) Match benchmark performance',
                              'B) Password tracking',
                              'C) Earnings tracking',
                              'D) Rate tracking'],
                  'correct': 0,
                  'explanation': 'Tracking refers to how closely an ETF matches its benchmark index.'}],
        'apply_action': {'type': 'market_overview'},
        'xp': 10},
 'B5': {'id': 'B5',
        'level': 'Beginner',
        ...
        'time_min': 6,
        'why_it_matters': 'Reduce risk by not putting all eggs in one basket',
        'summary': ['Diversification reduces single error impact',
                    "10 stocks in one sector isn't diversified",
                    'Idiosyncratic risk = company-specific',
                    'Different drivers matter more than different names'],
        'key_ideas': ['True diversification = different drivers',
                      'Sector concentration is hidden risk',
                      'International exposure adds diversity',
                      'Correlation matters (do they move together?)',
                      'Over-diversification dilutes returns'],
        'common_mistakes': ['Thinking more stocks = more diversified',
                            'All tech stocks = not diversified',
                            'Ignoring correlations',
                            'No bonds or cash cushion',
                            "Diversifying into things you don't understand"],
        'checklist': ['Check sector breakdown',
                      'Aim for different industries',
                      'Consider adding bonds/cash',
                      'Review correlations during stress'],
        'quiz': [{'question': 'Diversification:',
                  'options': ['A) Adds excitement',
                              'B) Reduces single error impact',
                              'C) Guarantees profits',
                              'D) Removes volatility'],
                  'correct': 1,
                  'explanation': 'Diversification reduces the impact of any single investment mistake or '
                                 'company-specific risk.'},
                 {'question': '10 stocks in one sector:',
                  'options': ['A) Well diversified', 'B) Theme-concentrated', 'C) Risk-free', 'D) Always better'],
                  'correct': 1,
                  'explanation': 'Multiple stocks in same sector = concentration risk, not true diversification.'},
                 {'question': 'Idiosyncratic risk:',
                  'options': ['A) Market-wide', 'B) Company-specific', 'C) Foreign exchange', 'D) Interest rate'],
                  'correct': 1,
                  'explanation': 'Idiosyncratic risk is specific to individual companies and can be reduced through '
                                 'diversification.'}],
        'apply_action': {'type': 'sector_explorer'},
        'xp': 10},
 'I1': {'id': 'I1',
        'level': 'Intermediate',
        'topics': ['Financials'],
        'title': 'Read Financials Quickly',
        'time_min': 8,
        'why_it_matters': 'Extract key insights from financial statements fast',
        'summary': ['Gross margin shows profit after direct costs',
                    'Operating margin includes operating expenses',
                    'FCF margin = free cash flow / revenue',
                    'Trends matter more than single quarters'],
        'key_ideas': ['Income statement = profitability',
                      'Balance sheet = financial health',
                      'Cash flow statement = actual cash moves',
                      'Margins reveal pricing power and efficiency',
                      'Compare to competitors and history'],
        'common_mistakes': ['Focusing only on revenue growth',
                            'Ignoring cash flow vs earnings',
                            'Not comparing to peers',
                            'Missing one-time items',
                            'Ignoring balance sheet health'],
        'checklist': ['Check revenue trend (3-5 years)',
                      'Review gross and operating margins',
                      'Verify FCF is positive and growing',
                      'Check debt levels vs cash flow'],
        'quiz': [{'question': 'Gross margin is:',
                  'options': ['A) Total debt', 'B) Profit after direct costs', 'C) Cash on hand', 'D) Dividend yield'],
                  'correct': 1,
                  'explanation': 'Gross margin = (Revenue - Cost of Goods Sold) / Revenue'},
                 {'question': 'Operating margin includes:',
                  'options': ['A) Taxes', 'B) Operating expenses', 'C) Capex only', 'D) Dividends only'],
                  'correct': 1,
                  'explanation': 'Operating margin accounts for operating expenses like R&D, sales, marketing.'},
                 {'question': 'FCF margin is:',
                  'options': ['A) FCF / Revenue', 'B) Revenue / Shares', 'C) Debt / Equity', 'D) P/S ratio'],
                  'correct': 0,
                  'explanation': 'FCF margin = Free Cash Flow / Revenue, shows % of sales converted to cash.'}],
        'apply_action': {'type': 'financial_health'},
        'xp': 15},
 'I2': {'id': 'I2',
        'level': 'Intermediate',
        'topics': ['Valuation', 'Buy & Hold'],
        'title': 'Growth Quality',
        'time_min': 7,
        'why_it_matters': 'Distinguish durable growth from hype',
        'summary': ['Durable growth = repeat demand + pricing power',
                    'Hype risk = expectations exceed reality',
                    'Recurring revenue tends to be more predictable',
                    'Quality matters more than growth rate alone'],
        'key_ideas': ['Check if growth is organic vs M&A',
                      'Customer retention signals quality',
                      'Margin expansion with growth = excellent',
                      "One-time tailwinds don't last",
                      'TAM size matters but execution matters more'],
        'common_mistakes': ['Chasing growth without checking quality',
                            'Ignoring competitive moats',
                            'Overpaying for future growth',
                            'Not checking customer concentration',
                            'Assuming growth continues forever'],
        'checklist': ['Verify revenue is recurring',
                      'Check customer retention rates',
                      'Review if margins improving with scale',
                      'Assess competitive advantages'],
        'quiz': [{'question': 'Durable growth supported by:',
                  'options': ['A) One-time events', 'B) Repeat demand + pricing', 'C) Dilution', 'D) Debt'],
                  'correct': 1,
                  'explanation': 'Sustainable growth comes from repeatable demand and ability to maintain/raise '
                                 'prices.'},
                 {'question': 'Hype risk:',
                  'options': ['A) Too much cash',
                              'B) Expectations > reality',
                              'C) Too many customers',
                              'D) Low volatility'],
                  'correct': 1,
                  'explanation': 'Hype risk occurs when market expectations exceed what fundamentals can deliver.'},
                 {'question': 'Recurring revenue tends to be:',
                  'options': ['A) More predictable', 'B) Always lower margin', 'C) Illegal', 'D) Only for banks'],
                  'correct': 0,
                  'explanation': 'Recurring revenue models (subscriptions) provide more predictable cash flows.'}],
        'apply_action': {'type': 'company_analysis', 'ticker': 'MSFT'},
        'xp': 15},
 'A1': {'id': 'A1',
        'level': 'Advanced',
        'topics': ['Risk', 'Diversification'],
        ...
        'time_min': 8,
        'why_it_matters': 'Avoid hidden concentration risk from correlated holdings',
        'summary': ['Hidden correlation = different names, same drivers',
                    'Many semiconductor stocks = theme concentration',
                    'Diversification works when drivers are different',
                    'Stress tests reveal true correlations'],
        'key_ideas': ['Correlations change during crashes',
                      'Check what drives each business',
                      "Geographic diversity helps but isn't enough",
                      'Cyclical stocks often move together',
                      'True hedges are hard to find'],
        'common_mistakes': ['Assuming different tickers = diversified',
                            'Ignoring supply chain links',
                            'Missing thematic exposures',
                            'Not stress-testing portfolio',
                            'Overconfidence in diversification'],
        'checklist': ['List key driver for each holding',
                      'Check if drivers are truly different',
                      'Review how portfolio behaved in past crashes',
                      'Consider adding uncorrelated assets'],
        'quiz': [{'question': 'Hidden correlation:',
                  'options': ['A) Different drivers', 'B) Same theme drivers', 'C) Cash holdings', 'D) Bond holdings'],
                  'correct': 1,
                  'explanation': 'Hidden correlation = holdings appear different but driven by same factors.'},
                 {'question': 'Many semiconductor stocks can be:',
                  'options': ['A) Diversified', 'B) Theme concentrated', 'C) Risk-free', 'D) Bond-like'],
                  'correct': 1,
                  'explanation': 'Multiple semicon stocks = sector/theme concentration, not true diversification.'},
                 {'question': 'Diversification works when:',
                  'options': ['A) Holdings similar', 'B) Drivers different', 'C) All tech', 'D) All momentum'],
                  'correct': 1,
                  'explanation': 'True diversification requires different fundamental drivers, not just different '
                                 'names.'}],
        'apply_action': {'type': 'portfolio_review'},
        'xp': 20},
 'P1': {'id': 'P1',
        'level': 'Behavior',
        'topics': ['Psychology'],
        'title': 'Loss Aversion',
        'time_min': 6,
        'why_it_matters': 'Understand why losses hurt more than gains feel good',
        'summary': ['Loss aversion = losses hurt ~2x more than equal gains',
                    'Causes panic selling at worst times',
                    'Defense = pre-committed process',
                    'Rules beat emotions'],
        'key_ideas': ['Biological bias, not weakness',
                      'Leads to holding losers too long',
                      'Also leads to selling winners too early',
                      "Can't eliminate but can manage",
                      'Position sizing reduces pain'],
        'common_mistakes': ['Ignoring the bias exists',
                            'Making decisions during peak emotion',
                            'No predetermined rules',
                            'Checking portfolio constantly',
                            'Letting paper losses drive decisions'],
        'checklist': ['Set rules before entering positions',
                      'Size positions so losses are tolerable',
                      'Review thesis, not just price',
                      'Use checklists during stress'],
        'quiz': [{'question': 'Loss aversion:',
                  'options': ['A) Love volatility',
                              'B) Losses hurt more than gains feel good',
                              'C) Gains worse',
                              'D) ETFs only'],
                  'correct': 1,
                  'explanation': 'Loss aversion = psychological bias where losses feel ~2x worse than equivalent '
                                 'gains.'},
                 {'question': 'Causes:',
                  'options': ['A) Calm buying', 'B) Panic selling', 'C) Better diversity', 'D) Lower taxes'],
                  'correct': 1,
                  'explanation': 'Loss aversion often causes panic selling during market downturns.'},
                 {'question': 'Defense:',
                  'options': ['A) Faster reactions', 'B) Pre-committed process', 'C) More news', 'D) Leverage'],
                  'correct': 1,
                  'explanation': 'Pre-committed rules and processes help counteract loss aversion bias.'}],
        'apply_action': {'type': 'risk_quiz'},
        'xp': 15},
 'R1': {'id': 'R1',
        'level': 'Repair',
        ...
        'time_min': 7,
        'why_it_matters': "Identify deteriorating businesses before it's too late",
        'summary': ['Weakness = multi-year declining revenue + margins',
                    'Debt danger = cash flow weak + debt grows',
                    'Dilution hurts per-share ownership',
                    'Exit criteria matter more than entry'],
        'key_ideas': ["One bad quarter isn't a trend",
                      'Check competitive position changes',
                      'Rising costs without pricing power = problem',
                      'Management excuses multiply',
                      'Balance sheet deterioration accelerates'],
        'common_mistakes': ['Averaging down into weakness',
                            'Ignoring fundamentals for price',
                            'Hope as a strategy',
                            'Not setting exit rules',
                            'Comparing only to past highs'],
        'checklist': ['Review 3-year revenue trend',
                      'Check margin direction',
                      'Verify debt coverage ratio',
                      'Assess competitive losses'],
        'quiz': [{'question': 'Weakness sign:',
                  'options': ['A) Stable revenue',
                              'B) Multi-year declining revenue + margins',
                              'C) Strong FCF',
                              'D) Low debt'],
                  'correct': 1,
                  'explanation': 'Sustained revenue and margin decline signals fundamental business deterioration.'},
                 {'question': 'Debt danger:',
                  'options': ['A) Cash flow strong',
                              'B) Cash flow weak + debt grows',
                              'C) Volatility rises',
                              'D) Dividends grow'],
                  'correct': 1,
                  'explanation': 'Weak cash flow + rising debt = dangerous combination, limits options.'},
                 {'question': 'Dilution hurts:',
                  'options': ['A) Ownership up', 'B) Per-share claim down', 'C) Lowers taxes', 'D) Guarantees growth'],
                  'correct': 1,
                  'explanation': 'Dilution increases share count, reducing your ownership percentage.'}],
        'apply_action': {'type': 'portfolio_review'},
        'xp': 15},
 'B6': {'id': 'B6',
        'level': 'Beginner',
        ...
        'title': 'ETFs 101',
        'time_min': 5,
        'why_it_matters': 'A simple way to diversify without picking individual winners',
        'summary': ['An ETF is a basket of investments you buy like a stock',
                    'It can hold hundreds of companies, spreading risk',
                    'Most index ETFs try to match an index (like the S&P 500)',
                    'Costs matter: expense ratio is the annual fee'],
        'key_ideas': ['Diversification reduces single-company risk',
                      'Index ETFs are usually low-cost and transparent',
                      'Trading an ETF is like trading a stock (price moves intraday)'],
        'common_mistakes': ["Buying a 'hot' themed ETF with high fees",
                            'Overtrading ETFs like day-trading',
                            'Ignoring what the ETF actually holds'],
        'checklist': ['Is the expense ratio low?',
                      'Does it track a broad index (for beginners)?',
                      'Do you understand the top holdings?'],
        'quiz': [{'question': 'An ETF is best described as:',
                  'options': ['A) One company stock',
                              'B) A basket you buy like a stock',
                              'C) A savings account',
                              'D) A bond contract'],
                  'correct': 1,
                  'explanation': 'ETFs bundle many holdings into one tradable security.'},
                 {'question': 'A main benefit of broad index ETFs is:',
                  'options': ['A) Guaranteed profits',
                              'B) Lower diversification',
                              'C) Diversification',
                              'D) Higher taxes'],
                  'correct': 2,
                  'explanation': 'Holding many companies reduces the impact of any single loser.'},
                 {'question': 'The expense ratio is:',
                  'options': ['A) The ETF’s daily price change',
                              'B) An annual fee charged by the fund',
                              'C) A one-time purchase fee',
                              'D) The dividend yield'],
                  'correct': 1,
                  'explanation': 'Expense ratios are annual fees taken from fund assets.'}],
        'apply_action': {'type': 'sector_explorer'},
        'xp': 10},
 'B7': {'id': 'B7',
        'level': 'Beginner',
        ...
        'time_min': 6,
        'why_it_matters': 'Reduce risk by not putting all eggs in one basket',
        'summary': ['Concentration can boost returns but increases blow-up risk',
                    'Diversification spreads risk across companies and sectors',
                    'Owning 20+ uncorrelated stocks is hard; ETFs make it easy',
                    'Rebalancing keeps risk consistent over time'],
        'key_ideas': ['Company risk vs market risk',
                      "Correlation matters: 'different' holdings can still move together",
                      'Simple default: broad index + small satellite positions (optional)'],
        'common_mistakes': ['Owning many stocks that are all in the same sector',
                            'Thinking 3 stocks is diversified',
                            'Chasing diversification into complicated products'],
        'checklist': ['Do I have exposure across sectors?',
                      'Am I overly concentrated in one stock?',
                      'Could a single headline wreck my portfolio?'],
        'quiz': [{'question': 'Diversification mainly helps reduce:',
                  'options': ['A) Market risk', 'B) Company-specific risk', 'C) Inflation risk', 'D) Tax risk'],
                  'correct': 1,
                  'explanation': 'Spreading across companies reduces the damage from one company failing.'},
                 {'question': 'If two holdings move together, they are:',
                  'options': ['A) Uncorrelated', 'B) Negatively correlated', 'C) Highly correlated', 'D) Risk-free'],
                  'correct': 2,
                  'explanation': 'High correlation means they often rise/fall together.'},
                 {'question': 'For beginners, the simplest diversification tool is usually:',
                  'options': ['A) Options', 'B) Leveraged ETFs', 'C) Broad index ETFs', 'D) Penny stocks'],
                  'correct': 2,
                  'explanation': 'Broad index ETFs provide instant diversification at low cost.'}],
        'apply_action': {'type': 'portfolio_review'},
        'xp': 10},
 'B8': {'id': 'B8',
        'level': 'Beginner',
        'topics': ['Risk', 'Foundations'],
        'title': 'Risk vs Return',
        'time_min': 6,
        'why_it_matters': 'Higher potential returns usually mean higher volatility and drawdowns',
        'summary': ['Risk shows up as volatility and the chance of permanent loss',
                    'Stocks beat cash long-term but can drop sharply short-term',
                    'Time horizon is your shock absorber',
                    'Your plan matters more than picking the perfect stock'],
        'key_ideas': ['Expected return is compensation for taking risk',
                      'Volatility is normal; the question is whether you can stick with it',
                      'Match risk to goals and timeline'],
        'common_mistakes': ['Taking stock-like risk for short-term money',
                            'Panicking on the first drawdown',
                            'Measuring success week-to-week instead of year-to-year'],
        'checklist': ['What’s my timeline for this money?',
                      'How would I react to a -20% drop?',
                      'Do I have an emergency fund before investing?'],
        'quiz': [{'question': 'In investing, ‘risk’ often means:',
                  'options': ['A) Guaranteed loss',
                              'B) Price fluctuations and uncertainty',
                              'C) A fixed interest rate',
                              'D) A coupon payment'],
                  'correct': 1,
                  'explanation': 'Risk is uncertainty—returns can vary widely.'},
                 {'question': 'A longer time horizon generally allows you to:',
                  'options': ['A) Avoid all losses',
                              'B) Take less diversification',
                              'C) Handle more volatility',
                              'D) Predict markets better'],
                  'correct': 2,
                  'explanation': 'More time increases the chance to recover from drawdowns.'},
                 {'question': 'Money needed in 6 months is usually best kept in:',
                  'options': ['A) Individual stocks',
                              'B) High-volatility crypto',
                              'C) Short-term safe cash equivalents',
                              'D) Leveraged ETFs'],
                  'correct': 2,
                  'explanation': 'Short-term goals shouldn’t take large market risk.'}],
        'apply_action': {'type': 'risk_quiz'},
        'xp': 10},
 'B9': {'id': 'B9',
        'level': 'Beginner',
        'topics': ['Buy & Hold', 'Foundations'],
        'title': 'Compounding + Time Horizon',
        'time_min': 7,
        'why_it_matters': 'Time is your biggest advantage in investing',
        'summary': ['Compounding means earning returns on past returns',
                    'Small differences in return add up over decades',
                    'Staying invested matters more than perfect timing',
                    'Consistency beats intensity'],
        'key_ideas': ['Compounding accelerates over time (the curve gets steeper)',
                      'Volatility hurts short-term but matters less over long horizons',
                      'Automating contributions reduces mistakes'],
        'common_mistakes': ['Stopping contributions during down markets',
                            'Trying to time every dip',
                            'Withdrawing long-term money for short-term wants'],
        'checklist': ['Do I have an automatic monthly contribution?',
                      'Is my investment timeline 5+ years for stocks?',
                      'Am I focusing on process, not headlines?'],
        'quiz': [{'question': 'Compounding is:',
                  'options': ['A) Paying taxes twice',
                              'B) Returns earning returns',
                              'C) Buying more stocks once',
                              'D) A type of dividend'],
                  'correct': 1,
                  'explanation': 'Compounding occurs when gains generate additional gains.'},
                 {'question': 'Compounding works best when you:',
                  'options': ['A) Invest for longer',
                              'B) Trade frequently',
                              'C) Avoid diversification',
                              'D) Borrow heavily'],
                  'correct': 0,
                  'explanation': 'Time is the key ingredient.'},
                 {'question': 'A good way to reduce emotional mistakes is:',
                  'options': ['A) Check prices hourly',
                              'B) Automate contributions',
                              'C) Follow rumors',
                              'D) Buy only ‘hot’ stocks'],
                  'correct': 1,
                  'explanation': 'Automation reduces reliance on willpower.'}],
        'apply_action': {'type': 'portfolio_review'},
        'xp': 10},
 'B10': {'id': 'B10',
         'level': 'Beginner',
         'topics': ['Foundations', 'Risk'],
         'title': 'Index Funds vs Single Stocks',
         'time_min': 6,
         'why_it_matters': 'Most beginners do better starting broad before picking individual names',
         'summary': ['Index funds/ETFs give broad exposure and diversification',
                     'Single stocks can outperform but increase company-specific risk',
                     'A simple default: core index + optional small single-stock ‘satellites’',
                     'Your behavior matters more than your ticker list'],
         'key_ideas': ['Core-satellite approach keeps the portfolio resilient',
                       'Single-stock risk includes bad management, competition, and surprises',
                       'Index investing is a valid ‘set it and forget it’ strategy'],
         'common_mistakes': ['Going all-in on one story stock',
                             'Believing diversification is ‘for losers’',
                             'Switching strategies every month'],
         'checklist': ['Is the majority of my portfolio diversified?',
                       'Do I understand the business behind any single stock I own?',
                       'Could I hold this through a big drawdown?'],
         'quiz': [{'question': 'A key advantage of index funds/ETFs is:',
                   'options': ['A) Guaranteed outperformance',
                               'B) Diversification',
                               'C) No fees ever',
                               'D) No price changes'],
                   'correct': 1,
                   'explanation': 'They spread risk across many companies.'},
                  {'question': 'Single stocks add more:',
                   'options': ['A) Company-specific risk',
                               'B) Guaranteed dividends',
                               'C) Bond-like stability',
                               'D) Tax-free returns'],
                   'correct': 0,
                   'explanation': 'A single company can disappoint for many reasons.'},
                  {'question': 'For a beginner, a reasonable starting approach is:',
                   'options': ['A) 100% one stock',
                               'B) Core index + optional small satellites',
                               'C) Only penny stocks',
                               'D) Only options'],
                   'correct': 1,
                   'explanation': 'This balances simplicity with optional exploration.'}],
         'apply_action': {'type': 'market_overview'},
         'xp': 10},
 'B11': {'id': 'B11',
         'level': 'Beginner',
         'topics': ['Foundations'],
         'title': 'Fees, Taxes, and Friction',
         'time_min': 6,
         'why_it_matters': 'Small costs quietly compound against you',
         'summary': ['Expense ratios, spreads, and frequent trading add up',
                     'Taxes can reduce your effective return',
                     'Holding longer can be tax-efficient (in taxable accounts)',
                     'Simple + low-cost is a competitive advantage'],
         'key_ideas': ['Costs compound negatively just like returns compound positively',
                       'High turnover often means higher taxes',
                       'Prioritize low-cost diversified funds first'],
         'common_mistakes': ['Ignoring expense ratios because they look small',
                             'Overtrading and paying spreads repeatedly',
                             'Chasing short-term gains in taxable accounts'],
         'checklist': ['Are my funds low-cost?',
                       'Am I trading more than I need to?',
                       'Do I understand my account type (taxable vs retirement)?'],
         'quiz': [{'question': 'A 1% annual fee over decades is:',
                   'options': ['A) Too small to matter',
                               'B) Can significantly reduce ending wealth',
                               'C) Always worth it',
                               'D) Only affects dividends'],
                   'correct': 1,
                   'explanation': 'Fees compound and can materially reduce long-term outcomes.'},
                  {'question': 'Bid-ask spread is:',
                   'options': ['A) A tax',
                               'B) The gap between buy and sell prices',
                               'C) A dividend payment',
                               'D) A bond coupon'],
                   'correct': 1,
                   'explanation': 'You often ‘pay’ the spread when you trade.'},
                  {'question': 'In a taxable account, holding longer can reduce taxes due to:',
                   'options': ['A) Tax-free gains',
                               'B) Long-term capital gains rates (often lower)',
                               'C) No reporting needed',
                               'D) Guaranteed refunds'],
                   'correct': 1,
                   'explanation': 'Longer holding periods can qualify for lower rates.'}],
         'apply_action': {'type': 'portfolio_review'},
         'xp': 10},
 'B12': {'id': 'B12',
         'level': 'Beginner',
         'topics': ['Foundations', 'Valuation'],
         'title': 'Valuation Intuition (P/E in Plain English)',
         'time_min': 7,
         'why_it_matters': 'Stops you from overpaying for hype—or underpaying for quality',
         'summary': ['P/E is price divided by earnings per share',
                     'High P/E can be fine if growth is high and durable',
                     'Low P/E can be a trap if earnings are shrinking',
                     'Use valuation as a range, not one magic number'],
         'key_ideas': ['P/E compares what you pay vs what the business earns',
                       'Always ask: will earnings grow, shrink, or stay flat?',
                       'Compare to a company’s own history and peers'],
         'common_mistakes': ['Thinking ‘low P/E’ automatically means cheap',
                             'Ignoring growth and business quality',
                             'Using one ratio without context'],
         'checklist': ['Is earnings growing over time?',
                       'Is the business quality improving or deteriorating?',
                       'Am I comparing apples-to-apples (same industry)?'],
         'quiz': [{'question': 'P/E stands for:',
                   'options': ['A) Profit/Expense', 'B) Price/Earnings', 'C) Price/Equity', 'D) Portfolio/ETF'],
                   'correct': 1,
                   'explanation': 'P/E is price divided by earnings per share.'},
                  {'question': 'A high P/E can be reasonable when:',
                   'options': ['A) Earnings are collapsing',
                               'B) Growth is strong and likely to continue',
                               'C) The company has no profits',
                               'D) Management is unknown'],
                   'correct': 1,
                   'explanation': 'Higher growth can justify a higher multiple.'},
                  {'question': 'A low P/E might be a trap if:',
                   'options': ['A) Earnings are growing fast',
                               'B) The business is improving',
                               'C) Earnings are declining or unstable',
                               'D) The company has a moat'],
                   'correct': 2,
                   'explanation': 'Declining earnings can make a stock ‘look cheap’ before it gets cheaper.'}],
         'apply_action': {'type': 'company_analysis'},
         'xp': 12},
 'I3': {'id': 'I3',
        'level': 'Intermediate',
        'topics': ['Financials'],
        ...
        'time_min': 8,
        'why_it_matters': 'Extract key insights from financial statements fast',
        'summary': ['Income statement shows profitability',
                    'Balance sheet shows what you own/owe',
                    'Cash flow shows real cash generation',
                    'Trends matter more than one quarter'],
        'key_ideas': ['Revenue → margin → earnings (and what’s driving each)',
                      'Debt + cash = flexibility',
                      'Free cash flow is often harder to fake'],
        'common_mistakes': ['Only looking at EPS without checking revenue and margins',
                            'Ignoring balance sheet debt',
        ...
        'quiz': [{'question': 'Which statement best shows cash actually generated?',
                  'options': ['A) Income statement', 'B) Balance sheet', 'C) Cash flow statement', 'D) Press release'],
                  'correct': 2,
                  'explanation': 'Cash flow statement tracks cash in/out.'},
                 {'question': 'If a company has high debt and falling cash, that suggests:',
                  'options': ['A) More flexibility',
                              'B) Higher financial risk',
                              'C) Guaranteed growth',
                              'D) Lower interest expense'],
                  'correct': 1,
                  'explanation': 'Less cash and more debt increases risk.'},
                 {'question': 'When scanning quickly, you should focus most on:',
                  'options': ['A) One-time items', 'B) Multi-year trends', 'C) Rumors', 'D) The CEO’s tweets'],
                  'correct': 1,
                  'explanation': 'Trends are more informative than one-off noise.'}],
        'apply_action': {'type': 'financial_health'},
        'xp': 15},
 'I4': {'id': 'I4',
        'level': 'Intermediate',
        'topics': ['Valuation'],
        'title': 'Valuation Tools (P/E, P/S, FCF)',
        'time_min': 8,
        'why_it_matters': 'Use a small toolkit to avoid valuation blind spots',
        'summary': ['P/E works best for steady profitable businesses',
                    'P/S is used when profits are low/volatile',
                    'FCF yield links price to cash generation',
                    'Compare within industry and to history'],
        'key_ideas': ['Different metrics fit different businesses',
                      'Cash flow quality matters (one-time vs recurring)',
                      'Valuation is a range, not a point'],
        'common_mistakes': ['Comparing P/E across unrelated industries',
                            'Using P/S without checking margins',
                            'Ignoring dilution (share count rising)'],
        'checklist': ['Which metric matches this business model?',
                      'How does it compare to peers?',
                      'Is cash flow consistent?'],
        'quiz': [{'question': 'P/S is often used when:',
                  'options': ['A) Profits are very stable',
                              'B) A company has no meaningful revenue',
                              'C) Profits are low or volatile',
                              'D) Dividends are high'],
                  'correct': 2,
                  'explanation': 'P/S helps when earnings aren’t representative.'},
                 {'question': 'FCF yield roughly measures:',
                  'options': ['A) Cash generated relative to price',
                              'B) Revenue growth rate',
                              'C) Interest rate risk',
                              'D) Dividend schedule'],
                  'correct': 0,
                  'explanation': 'It connects free cash flow to valuation.'},
                 {'question': 'Comparisons are most useful when they are:',
                  'options': ['A) Across any companies',
                              'B) Within the same industry/peers',
                              'C) Only across countries',
                              'D) Only across time periods'],
                  'correct': 1,
                  'explanation': 'Businesses are valued differently by industry.'}],
        'apply_action': {'type': 'company_analysis'},
        'xp': 15},
 'I5': {'id': 'I5',
        'level': 'Intermediate',
        'topics': ['Foundations', 'Buy & Hold'],
        'title': 'Earnings, Guidance, and Surprises',
        'time_min': 7,
        'why_it_matters': 'Stocks move on what changed vs expectations, not just the headline',
        'summary': ['Markets price in expectations before earnings',
                    'Surprises (beat/miss) and guidance drive moves',
                    'One quarter rarely changes a great long-term business',
                    'Listen for drivers: demand, margins, and outlook'],
        'key_ideas': ['Expectations vs results is the game',
                      'Forward guidance can matter more than past results',
                      'Separate noise from signal'],
        'common_mistakes': ['Buying right before earnings with no plan',
                            'Overreacting to one quarter',
                            'Confusing revenue growth with profit growth'],
        'checklist': ['What were expectations going in?',
                      'Did guidance move up/down?',
                      'Any change in margins or cash flow?'],
        'quiz': [{'question': 'Stocks often move after earnings because:',
                  'options': ['A) Earnings are random',
                              'B) The SEC sets prices',
                              'C) Results vs expectations changed',
                              'D) Dividends reset daily'],
                  'correct': 2,
                  'explanation': 'The ‘surprise’ relative to expectations drives repricing.'},
                 {'question': 'Guidance refers to:',
                  'options': ['A) Past revenue',
                              'B) Management’s forward outlook',
                              'C) Stock splits',
                              'D) Interest rates'],
                  'correct': 1,
                  'explanation': 'Guidance is forward-looking commentary.'},
                 {'question': 'A good long-term investor should usually:',
                  'options': ['A) Trade every earnings report',
                              'B) Focus on multi-year drivers',
                              'C) Ignore cash flow',
                              'D) Only watch price charts'],
                  'correct': 1,
                  'explanation': 'Long-term drivers matter most.'}],
        'apply_action': {'type': 'market_overview'},
        'xp': 15},
 'I6': {'id': 'I6',
        'level': 'Intermediate',
        ...
        'time_min': 7,
        'why_it_matters': 'Distinguish durable growth from hype',
        'summary': ['Quality growth shows in margins, retention, and cash flow',
                    'Revenue growth alone can be misleading',
                    'Look for unit economics and repeatability',
                    'A great business can still be a bad stock at the wrong price'],
        'key_ideas': ['Growth + profitability + cash flow is powerful',
                      'Watch for improving gross margins and operating leverage',
                      'Price paid determines return'],
        'common_mistakes': ['Chasing growth without checking profitability',
                            'Ignoring valuation during hype cycles',
                            'Assuming a great product means a great investment'],
        'checklist': ['Are margins improving?',
                      'Is free cash flow trending up?',
                      'Is growth repeatable without huge spending?'],
        'quiz': [{'question': 'A sign of ‘quality growth’ is:',
                  'options': ['A) Rising revenue but collapsing margins',
                              'B) Improving margins with consistent growth',
                              'C) No revenue',
                              'D) Constant dilution'],
                  'correct': 1,
                  'explanation': 'Durable growth often comes with improving efficiency.'},
                 {'question': 'Why can a great business be a bad stock?',
                  'options': ['A) Stocks are random',
                              'B) Price may already be too high',
                              'C) Earnings don’t matter',
                              'D) Only dividends matter'],
                  'correct': 1,
                  'explanation': 'Overpaying can lead to poor returns even for great businesses.'},
                 {'question': 'Operating leverage means:',
                  'options': ['A) Costs rise faster than revenue',
                              'B) Profits can grow faster than revenue as scale increases',
                              'C) Debt always increases',
                              'D) Dividends shrink'],
                  'correct': 1,
                  'explanation': 'Scaling can expand margins and profits.'}],
        'apply_action': {'type': 'portfolio_review'},
        'xp': 15},
 'A2': {'id': 'A2',
        'level': 'Advanced',
        ...
        'time_min': 8,
        'why_it_matters': 'Avoid hidden concentration risk from correlated holdings',
        'summary': ['Your portfolio can look diversified but still move as one',
                    'Tech-heavy ETFs and growth stocks can be highly correlated',
                    'Stress test: what happens if one theme sells off?',
                    'Diversify across drivers, not just tickers'],
        'key_ideas': ['Correlation rises in crises',
                      'Factor exposure (growth/value) matters',
                      'True diversification includes different sectors/asset types'],
        'common_mistakes': ['Owning many ‘different’ tech names',
                            'Assuming 2 ETFs means diversified',
                            'Ignoring factor and sector weights'],
        'checklist': ['Are my top holdings in the same sector?',
                      'Would one macro shock hit everything I own?',
                      'Do I have a clear ‘why’ for each position?'],
        'quiz': [{'question': 'Correlation risk shows up when:',
                  'options': ['A) Holdings move together',
                              'B) Holdings never move',
                              'C) Dividends increase',
                              'D) Taxes fall'],
                  'correct': 0,
                  'explanation': 'High correlation means positions move together.'},
                 {'question': 'Correlation tends to:',
                  'options': ['A) Fall in crises', 'B) Rise in crises', 'C) Stay zero', 'D) Become negative always'],
                  'correct': 1,
                  'explanation': 'In market stress, many assets move together.'},
                 {'question': 'Better diversification focuses on:',
                  'options': ['A) More tickers only',
                              'B) Different drivers/exposures',
                              'C) Only one sector',
                              'D) Only one country'],
                  'correct': 1,
                  'explanation': 'Diversify across what drives returns.'}],
        'apply_action': {'type': 'portfolio_review'},
        'xp': 18},
 'A3': {'id': 'A3',
        'level': 'Advanced',
        'topics': ['Risk', 'Portfolio Analysis'],
        'title': 'Position Sizing (Simple Rules)',
        'time_min': 7,
        'why_it_matters': 'Sizing matters as much as stock selection for long-term survival',
        'summary': ['Big positions can dominate your outcomes',
                    'Size positions based on confidence and risk',
                    'Use caps (e.g., 5–10% per single stock) to prevent blow-ups',
                    'Rebalance when a position becomes too large'],
        'key_ideas': ['Risk = position size × volatility',
                      'Concentration is a choice—make it explicit',
                      'Defaults protect beginners from one mistake'],
        'common_mistakes': ['Going all-in because you ‘love’ a stock',
                            'Letting one winner become 50% of the portfolio by accident',
                            'Using leverage without understanding downside'],
        'checklist': ['Do I have a max position size rule?',
                      'Would I be okay if this stock dropped 40%?',
                      'Am I diversified across ideas?'],
        'quiz': [{'question': 'Position sizing controls:',
                  'options': ['A) Only taxes',
                              'B) How much one holding impacts you',
                              'C) Whether markets go up',
                              'D) Dividend schedules'],
                  'correct': 1,
                  'explanation': 'Sizing determines impact of any one holding.'},
                 {'question': 'A beginner-friendly single-stock cap might be:',
                  'options': ['A) 100%', 'B) 50%', 'C) 5–10%', 'D) 0%'],
                  'correct': 2,
                  'explanation': 'Caps reduce blow-up risk from one position.'},
                 {'question': 'If a position grows too large, a common action is to:',
                  'options': ['A) Ignore it', 'B) Rebalance/trim', 'C) Double down always', 'D) Switch brokers'],
                  'correct': 1,
                  'explanation': 'Rebalancing maintains intended risk.'}],
        'apply_action': {'type': 'portfolio_review'},
        'xp': 18},
 'P2': {'id': 'P2',
        'level': 'Behavior',
        ...
        'time_min': 7,
        'why_it_matters': 'Understand why losses hurt more than gains feel good',
        'summary': ['People feel losses more intensely than gains',
                    'This can cause panic selling at the worst time',
                    'Plans and rules reduce emotional decisions',
                    'Focus on process and long-term goals'],
        'key_ideas': ['Loss aversion is normal, not a personal failure',
                      'Pre-commitment helps (allocation, contributions, rebalancing rules)',
                      'Zoom out: long-term charts reduce noise'],
        'common_mistakes': ['Checking portfolio too often',
                            'Selling after a drop and buying back higher',
                            'Changing strategy mid-storm'],
        'checklist': ['How often will I check my portfolio?',
                      'Do I have a written plan for drawdowns?',
                      'Is my allocation aligned with my risk quiz result?'],
        'quiz': [{'question': 'Loss aversion means:',
                  'options': ['A) Loving risk',
                              'B) Losses feel worse than equal gains feel good',
                              'C) Ignoring prices',
                              'D) Always buying dips'],
                  'correct': 1,
                  'explanation': 'Humans typically experience losses more strongly than gains.'},
                 {'question': 'A practical way to reduce emotional decisions is:',
                  'options': ['A) Check prices hourly',
                              'B) Write rules in advance',
                              'C) Trade more often',
                              'D) Follow rumors'],
                  'correct': 1,
                  'explanation': 'Rules reduce impulse decisions.'},
                 {'question': 'Panic selling often happens:',
                  'options': ['A) After prices already fell',
                              'B) Before any decline',
                              'C) Only in bull markets',
                              'D) Never'],
                  'correct': 0,
                  'explanation': 'People tend to sell after declines due to fear.'}],
        'apply_action': {'type': 'risk_quiz'},
        'xp': 15},
 'R2': {'id': 'R2',
        'level': 'Repair',
        'topics': ['Portfolio Analysis'],
        'title': 'When to Sell (Simple Framework)',
        'time_min': 7,
        'why_it_matters': 'Selling is harder than buying—use rules to stay rational',
        'summary': ['Sell if the thesis is broken (fundamentals changed)',
                    'Sell if you made a mistake and risk is unacceptable',
                    'Consider trimming if one position is too large',
                    'Avoid selling just because the price dipped'],
        'key_ideas': ['Price down ≠ thesis broken (sometimes it’s just volatility)',
                      'Fundamentals, valuation, and portfolio fit drive decisions',
                      'Have ‘sell triggers’ before you buy'],
        'common_mistakes': ['Selling winners too early and holding losers too long',
                            'Making decisions purely from price action',
                            'Overtrading based on news'],
        'checklist': ['What was my original thesis?',
                      'What changed since I bought?',
                      'Does this still fit my risk and timeline?'],
        'quiz': [{'question': 'A strong reason to sell is:',
                  'options': ['A) The stock fell 2%',
                              'B) Your thesis is broken',
                              'C) A headline you didn’t read',
                              'D) Your friend sold'],
                  'correct': 1,
                  'explanation': 'If fundamentals changed, the original reason to own may be gone.'},
                 {'question': 'Trimming is often used when:',
                  'options': ['A) A position becomes too large',
                              'B) You want more concentration',
                              'C) You hate diversification',
                              'D) Taxes don’t exist'],
                  'correct': 0,
                  'explanation': 'Trimming controls risk and concentration.'},
                 {'question': 'A weak reason to sell is:',
                  'options': ['A) A clear fraud',
                              'B) Permanent business deterioration',
                              'C) ‘I’m bored’',
                              'D) Balance sheet stress'],
                  'correct': 2,
                  'explanation': 'Boredom isn’t an investment thesis.'}],
        'apply_action': {'type': 'portfolio_review'},
        'xp': 15}}
